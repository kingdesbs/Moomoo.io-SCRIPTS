...
// If you are a coder and you read this code, then MooUI is my new library for quick and easy menu creation in moomoo.io or other games. Try now: https://github.com/Nudo-o/MooUI
...
, function(e, t, i) {
                ...
                function() {
                    ...
                    for (var t = 0; t < l.weapons.length + l.list.length; ++t)
                        !function(e) {
                            ...
                            const actionBarItem = document.getElementById(`actionBarItem${e}`)
                            const limit = window.inSandbox ? Math.max(3 * l.list[id].group.limit, 99) : l.list[id].group.limit

                            actionBarItem.insertAdjacentHTML("beforeend", `<span class="item-count" id="itemCount_${id}" style="display: none; color: #fff; font-size: 14px;">${menu.getModelActive("item-counts") ? `0/${limit}` : ""}</span>`)
    ...
    var C, P, E, O, B, j, A, D, U, R, L, z, _, F, H = M("moofoll"), V = 1, q = Date.now(), W = [], X = [], G = [], N = [], Y = [], K = new p(f,Y,X,W,tt,l,r,o), J = i(35), Q = i(36), $ = new J(W,Q,X,l,null,r,o), Z = 1, ee = 0, te = 0, ie = 0, ne = {
        ...
        currentX: 0,
        currentY: 0
    }, oe = 0, maxScreenWidth = r.maxScreenWidth, maxScreenHeight = r.maxScreenHeight, ce = !1, le = (document.getElementById("ad-container"),
    ...
    for (let i = 0; i < settingsMap.length; i++) {
        const visualSettings = JSON.parse(localStorage.getItem("visual-settings") || null)
    ...
    playersVisual.add(new window.MooUI.Checkbox({
        ...
        options: [
            ...
            new window.MooUI.OptionCheckbox({
                key: "shame-hat",
                name: "Shame Hat",
                description: "Gradually increases the visibility of the shame cap depending on the amount of shame",
    ...
    playersVisual.add(new window.MooUI.Checkbox({
        ...
        options: [
            new window.MooUI.OptionCheckbox({
                ...
                name: "All Players",
                description: "If enabled, the movement tail will be drawn for all players",
    ...
    buildingsVisual.add(new window.MooUI.Checkbox({
        ...
        name: "Health Bar",
        description: "Shows the health of buildings in the form of a rectangular bar",
    ...
    buildingsVisual.add(new window.MooUI.Checkbox({
        ...
        description: "Shows after how long the turret will shoot in the form of a bar",
    ...
    gameVisual.add(new window.MooUI.Checkbox({
        ...
        options: [
            ...
            new window.MooUI.OptionCheckbox({
                key: "desert-coast",
                name: "Desert Coast",
                description: "Creates a smooth transition between desert and grass",
    ...
    gameVisual.add(new window.MooUI.Checkbox({
        ...
        options: [
            ...
            new window.MooUI.OptionCheckbox({
                ...
                description: "Disable the text that flies out of the player when he takes damage or heals",
                isActive: settings["disable-damage-text"]
            }),
            new window.MooUI.OptionCheckbox({
                key: "disable-object-wiggle",
                name: "Disable Object Wiggle",
                description: "Disables the object's repulsion when it is hit or it shoots",
    ...
    gameVisual.add(new window.MooUI.Checkbox({
        ...
        options: [
            new window.MooUI.OptionCheckbox({
                ...
                name: "Float Left",
                description: "Changes the direction of displacement along the X axis",
    ...
    gameVisual.add(new window.MooUI.Checkbox({
        ...
        options: [
            ...
            new window.MooUI.OptionCheckbox({
                ...
                name: "Resources",
                description: "Draws submerged trees, bushes, and rocks on a minimap",
    ...
    we.addEventListener("wheel", (event) => {
        ...
        if ((storeMenu.style.display && storeMenu.style.display !== "none") || (allianceMenu.style.display && allianceMenu.style.display !== "none")) return

        if (!menu.getModelActive("wheel-zoom") || !player?.alive || document.activeElement.tagName === "INPUT") return
    ...
    ot.innerHTML = `
    <a target="_blank" class="ytLink" href="https://www.youtube.com/@nudo1050/featured">
    ...
    function pt() {
        ...
        e.onreadystatechange = function() {
            ...
            (y.processServers instanceof Function && y.processServers(vultr.servers)),
    ...
    function oi() {
        ...
        ve.setTransform(scale, 0, 0, scale, (_ * V - maxScreenWidth * scale) / 2, (F * V - maxScreenHeight * scale) / 2)
    ...
    function ci() {
        ...
        return (-1 != se.id ? ii = Math.atan2(se.currentY - se.startY, se.currentX - se.startX) : A.lockDir || ti || (ii = Math.atan2(ie - F / 2, te - _ / 2)),
        o.fixTo(ii || 0, 2))
    }
    ...
    window.addEventListener("keydown", o.checkTrusted((function(e) {
        if (document.activeElement.tagName === "INPUT" && e.keyCode !== 13 && e.keyCode !== 27) return
    ...
    function Ti(sid) {
        ...
        if (tmpObject.visibleToPlayer(A) && menu.getModelActive("destroy-animation") && tmpObject.isItem) {
    ...
    function renderGameObjects(e, t, i) {
        for (let n, s, o, a = 0; a < N.length; ++a) {
            ...
            if (U.layer == e && isOnScreen(s, o, U.scale + (U.blocker || 0))) {
                ...
                ve.globalAlpha = menu.getModelActive("destroy-animation") ? U.isDestroying ? 1 - U.getDestroyAlpha() : defaultAlpha : defaultAlpha
                ...
                if (U.isItem) {
                    ...
                    if (U.name === "turret") {
                        if (menu.getModelActive("turret-range-indicator")) {
                            ...
                            const color = isClanMember(U.owner.sid) ? "#7ad025" : "#cc5151"
                            ...
                            ve.beginPath()
                            ve.moveTo(s, o)
                            ve.lineTo(s + range * Math.cos(U.dir), o + range * Math.sin(U.dir))
                            ve.stroke()
                            ve.beginPath()
                            ve.arc(s + range * Math.cos(U.dir), o + range * Math.sin(U.dir), U.scale / 2, 0, Math.PI * 2)
                            ve.closePath()
                            ve.stroke()
                            ve.restore()
                        }
                    ...
                    if (U.name === "turret") {
                        if (menu.getModelActive("turret-reload-bar")) {
                            ...
                            let shootReload = ((Date.now() - U.shootTime) / U.shootCooldown)

                            if (!U.shootTime || Date.now() - U.shootTime >= U.shootCooldown) {
                                shootReload = 1
                            }

                            ve.save()
                            ve.fillStyle = nt
                            ve.roundRect(s - width - r.healthBarPad, o + U.scale + yOffset, 2 * width + 2 * r.healthBarPad, 17, 8)
                            ve.fill()

                            ve.fillStyle = menu.getModelValue("turret-reload-bar-color")
                            ve.roundRect(s - width, o + U.scale + yOffset + r.healthBarPad, 2 * width * shootReload, 17 - 2 * r.healthBarPad, 7)
                            ve.fill()
                            ve.restore()
                        }
                    }
                    ...
                    if (!U.isDestroying) {
                        for (const player of X) {
                            ...
                            const angle = Math.atan2(U.y - player.y, U.x - player.x)
                            const distance = Math.hypot(U.y - player.y, U.x - player.x)

                            if ([9, 11, 12, 13, 15].includes(player.weaponIndex)) continue

                            const targetRange = l.weapons[player.weaponIndex].range * parseInt(menu.getModelValue("building-health-bar-range"))

                            if (distance > targetRange || getAngleDist(angle, player.dir) > gatherAngle) continue

                            if (menu.getModelActive("building-health-bar")) {
                                if (menu.getModelActive("building-health-bar-use-round")) {
                                    const endAngle = ((U.health / U.maxHealth) * 360) * (Math.PI / 180)
                                    const width = 14
                                    const scale = 22
                                    ...
                                    ve.save()
                                    ve.strokeStyle = isClanMember(U.owner.sid) ? "#8ecc51" : "#cc5151"
                                    ...
                                    const height = 17
                                    const radius = 8
                                    const color = isClanMember(U.owner.sid) ? "#8ecc51" : "#cc5151"

                                    ve.save()
                                    ve.fillStyle = nt
                                    ve.roundRect(s - width - r.healthBarPad, o - height / 2, 2 * width + 2 * r.healthBarPad, height, radius)
                                    ve.fill()

                                    ve.fillStyle = color
                                    ve.roundRect(s - width, o - height / 2 + r.healthBarPad, 2 * width * (U.health / U.maxHealth), height - 2 * r.healthBarPad, radius - 1)
                                    ve.fill()
                                    ve.restore()
                                }
                            }

                            if (menu.getModelActive("buildings-health-text") && U.maxHealth) {
                                ve.save()
                                ...
                                ve.lineWidth = 8
                                ve.lineJoin = "round"
                                ve.strokeText(`${~~U.health}/${~~U.maxHealth}`, s, o)
                        ...
                        if (!minimapResources.has(U.sid)) {
                            minimapResources.set(U.sid, {
                                ...
                                render(context, xOffset, yOffset) {
                                    const biomeID = this.target.y >= r.mapScale - r.snowBiomeTop ? 2 : this.target.y <= r.snowBiomeTop ? 1 : 0

                                    function getPosition(position) {
                                        return position / r.mapScale * ((Ge.width + Ge.height) / 2)
                                    }
                                    ...
                                    context.save()
                                    context.translate(getPosition(this.target.x), getPosition(this.target.y))
                                    context.strokeStyle = "#525252"
                                    context.lineWidth = 1

                                    switch (this.target.type) {
                                        case 0: {
                                            const color = biomeID ? i ? "#fff" : "#e3f1f4" : i ? "#b4db62" : "#9ebf57"

                                            for (let i = 0; i < 2; ++i) {
                                                const scale = 5.85

                                                tn(context, 7, scale, .7 * scale) // render star
                                        ...
                                        case 1: {
                                            ...
                                            if (biomeID === 2) {
                                                ...
                                                for (let i = 0; i < spikes; i++) {
                                                    blobOuter = ((scale + 0.9) + scale * 1.2) / 4

                                                    context.quadraticCurveTo(
                                                        Math.cos(blobRotate + blobSteps) * blobOuter, Math.sin(blobRotate + blobSteps) * blobOuter,
                                                        Math.cos(blobRotate + (blobSteps * 2)) * .7 * scale, Math.sin(blobRotate + (blobSteps * 2)) * .7 * scale
                                                    )
                                                ...
                                                context.fillStyle = biomeID ? "#e3f1f4" : "#89a54c"
                                                context.fill()
                                                context.stroke()
                                                context.fillStyle = biomeID ? "#6a64af" : "#c15555"

                                                const rotateValue = I / 4

                                                for (let i = 0; i < 4; ++i) {
                                                    const range = (scale / 3 + scale / 2.3) / 2

                                                    en(range * Math.cos(rotateValue * i), range * Math.sin(rotateValue * i), scale / range, context)
                                                }
                                            }
                                        } break
                                        ...
                                        case 3: {
                                            const scale = 5.5
                                            const color1 = 2 == this.target.type ? 2 == biomeID ? "#938d77" : "#939393" : "#e0c655"
                                            const color2 = 2 == this.target.type ? 2 == biomeID ? "#b2ab90" : "#bcbcbc" : "#ebdca3"
                                            ...
                                            tn(context, 3, .55 * scale, .65 * scale)
                                            context.fill()
                                        } break
                                    }
    ...
    function gatherAnimation(e, t, i) {
        ...
        for (const gameObject of N) {
            if (!gameObject.isItem || !gameObject.active || gameObject.isDestroying) continue

            const angle = Math.atan2(gameObject.y - U.y, gameObject.x - U.x)
            const distance = Math.hypot(gameObject.y - U.y, gameObject.x - U.x) - (gameObject.scale || gameObject.getScale()) + r.collisionDepth

            if (distance > l.weapons[U.weaponIndex].range || getAngleDist(angle, U.dir) > gatherAngle) continue

            if (menu.getModelActive("building-health-bar")) {
                const tmpVariant = r.fetchVariant(U)
                const variatDamage = tmpVariant.val
                const weapon = l.weapons[U.weaponIndex]
                const damage = weapon.dmg * (variatDamage || 1) * (weapon?.sDmg || 1) * (window.hatsConfig.getById(U.skinIndex)?.bDmg || 1)
        ...
        for (const player of X) {
            ...
            const distance = Math.hypot(player.y - U.y, player.x - U.x) - player.scale
    ...
    function Hi(e, t, i) {
        ...
        for (let n = 0; n < X.length; ++n) {
            ...
            const shameHat = menu.getModelActive("shame-indicators") && menu.getModelActive("shame-hat")
            ...
            if (shameHat && Wi.shameImg.isLoaded && A.alive && A.active) {
                ...
                ve.drawImage(Wi.shameImg, -Wi.shameImg.scale / 2, -Wi.shameImg.scale / 2, Wi.shameImg.scale, Wi.shameImg.scale)
                ve.restore()
            }
        }
    }
    ...
    var Ji = {};
    function Qi(e) {
        var t = e.y >= r.mapScale - r.snowBiomeTop ? 2 : e.y <= r.snowBiomeTop ? 1 : 0 // biomeID
    ...
    function cn(x, y, dir, range, speed, indx, layer, sid, original) {
        if (ct) {
            K.addProjectile(x, y, dir, range, speed, indx, null, null, layer).sid = sid
        }

        if (!menu.getModelActive("reload-bars") || !menu.getModelActive("reload-bars-secondary")) return
        ...
        for (const player of X) {
            ...
            if (typeof item.projectile === 'undefined' || (player.d2 - dir) > .4 || (distance < 69 && distance > 72)) continue
        ...
        if (U.oldHealth < health) {
            ...
            if (menu.getModelActive("health-particles")) {
                ...
                for (let i = 0; i < amount; i++) {
                    particles.create("health", U.x, U.y, 40, menu.getModelValue("health-particles-color"), Math.random() * 2 + 1, 600, true, "+")
                }
            }
        } else {
            if (health <= 0) {
            ...
            if (menu.getModelActive("blood-particles")) {
                ...
                for (let i = 0; i < amount; i++) {
                    particles.create("blood", U.x, U.y, 40, menu.getModelValue("blood-particles-color"), Math.random() * 2 + 1, 600, true, "-")
                }
            }
        }
    ...
    function BuildPosition(id, x, y, building, angle, buildRadius) {
        ...
        this.setTo = function(x, y) {
            ...
            this.buildX = this.x - (this.building.scale / 2 + Math.abs(this.building.placeOffset * 2)) * Math.cos(this.angle)
            this.buildY = this.y - (this.building.scale / 2 + Math.abs(this.building.placeOffset * 2)) * Math.sin(this.angle)
        }
        ...
        this.render = function() {
            ...
            ve.beginPath()
            ve.arc(this.x - window.xOffset, this.y - window.yOffset, this.radius, 0, Math.PI * 2)
            ve.fill()
            ve.restore()
            ...
            ve.beginPath()
            ve.arc(this.buildX - window.xOffset, this.buildY - window.yOffset, this.radius, 0, Math.PI * 2)
            ve.fill()
            ve.restore()
        }
        ...
        this.update = function() {
            ...
            for (let i = 0; i < N.length; i++) {
                ...
                const distance = Math.hypot(this.y - building.y, this.x - building.x) - (building.getScale ? building.getScale() : building.scale)
                const angle = Math.atan2(building.y - this.y, building.x - this.x)

                if (!isOnScreen(building.x - window.xOffset, building.y - window.yOffset, building.scale + (building.blocker || 0))) continue
    ...
    function updateBuildPosition() {
        ...
        const radius = buildPositions.radius = A.scale * 2 + building.scale + Math.abs(building.placeOffset)
        const steps = radius
        ...
        for (let i = 0; i < steps; i++) {
            ...
            buildPositions.set(i, new BuildPosition(i, x, y, building, angle, radius))
        }
    ...
    function renderFreeBuildPositions() {
        ...
        const freePositions = Array.from(buildPositions.values()).filter((buildPosition) => buildPosition.canBuild)

        for (let i = 0; i < freePositions.length; i++) {
            const freePosition = freePositions[i]
            const positions = freePositions.filter((position) => position.id !== freePosition.id && position.isCanBuild)
            const nearPosition = positions.sort((a, b) =>
                                                Math.hypot(a.buildY - freePosition.buildY, a.buildX - freePosition.buildX) -
                                                Math.hypot(b.buildY - freePosition.buildY, b.buildX - freePosition.buildX)
                                               )[0]

            if (nearPosition) {
                const distance = Math.hypot(nearPosition.buildY - freePosition.buildY, nearPosition.buildX - freePosition.buildX)

                if (distance <= freePosition.building.scale) continue
            }

            const isCanBuild = tt.checkItemLocation(freePosition.buildX, freePosition.buildY, freePosition.building.scale, .6, freePosition.building.id, false)
            ...
            if (isCanBuild) {
                ...
                ve.beginPath()
                ve.globalAlpha = .25
                ve.arc(freePosition.buildX - window.xOffset, freePosition.buildY - window.yOffset, freePosition.building.scale, 0, Math.PI * 2)
                ve.fill()
                ve.globalAlpha = .55
                ve.arc(freePosition.buildX - window.xOffset, freePosition.buildY - window.yOffset, freePosition.building.scale, 0, Math.PI * 2)
                ve.stroke()
    ...
    function Tn() {
        ...
        window.togglePingDisplay = function() {
            if (menu.getModelActive("show-stats")) {
                if (pingDisplay.style.display === "none" || !pingDisplay.style.display) {
                    pingDisplay.style.display = "block"
                }
            } else if (pingDisplay.style.display === "block" || !pingDisplay.style.display) {
    ...
    function Particle(id, type, x, y, radius, angle, color, power, deathCooldown, isText = false, text) {
        this.id = id
        this.type = type
        this.x = x
        this.y = y
        ...
        this.update = function() {
            if (Date.now() - this.lifeTime >= (this.deathCooldown - Math.max(window.fps, window.delta))) return this.destroy()
    ...
    function Particles() {
        ...
        this.create = function(type, x, y, radius, color, power, deathCooldown = 1000, isText, text) {
            const particle = new Particle(Date.now() * Math.random(), type, x, y, radius, Math.random() * Math.PI * 2, color, power, deathCooldown, isText, text)
    ...
    function ShorePath(startX, startY, endX, color, distance, float) {
        ...
        this.render = function(xOffset, yOffset) {
            ...
            for (let i = 1; i < path.length; i++) {
                ...
                ve.lineTo(oldPoint[0] + this.distance * 2 - xOffset, this.startY - yOffset)
    ...
    const snowPath = new ShorePath(-maxScreenWidth, r.snowBiomeTop - 1, r.mapScale + maxScreenWidth * 2, "#fff", 50, "down")
    const desertPath = new ShorePath(-maxScreenWidth, r.mapScale - r.snowBiomeTop + 1, r.mapScale + maxScreenWidth * 2, "#dbc666", 50, "up")
    ...
    function() {
        ...
        for (let i = 0; i < 25; i++) {
            ...
            tt.add(index, mapMiddle - xOffset * Math.cos(angle), mapMiddle - yOffset * Math.sin(angle), 0, scale, 0)
        }
        ...
        for (let i = 0; i < 75; i++) {
            ...
            tt.add(index, mapMiddle - xOffset * Math.cos(angle), mapMiddle - yOffset * Math.sin(angle), 0, scale, 1)
        }
        ...
        for (let i = 0; i < 25; i++) {
            ...
            tt.add(index, mapMiddle - xOffset * Math.cos(angle), mapMiddle - yOffset * Math.sin(angle), 0, scale, 2)
        }
        ...
        tt.add(index + 1, mapMiddle, mapMiddle, 0, l.list[4].scale, l.list[4].id, l.list[10])
    }(),
    function e() {
        ...
        ! function() {
            ...
            if (A) {
                ...
                const tmpSpeed = menu.getModelActive("smooth-camera") ? 0.0045 : .01
            ...
            // RENDER BACKGROUND:
            if (r.snowBiomeTop - f <= 0 && r.mapScale - r.snowBiomeTop - f >= maxScreenHeight) {
                ve.fillStyle = "#b6db66"
                ...
                ve.fillStyle = "#b6db66"
                ve.fillRect(0, r.snowBiomeTop - f, maxScreenWidth, maxScreenHeight - (r.snowBiomeTop - f))
                ...
                ve.fillStyle = "#b6db66"
                ve.fillRect(0, 0, maxScreenWidth, (r.mapScale - r.snowBiomeTop - f))
                ve.fillStyle = "#dbc666"
                ve.fillRect(0, (r.mapScale - r.snowBiomeTop - f), maxScreenWidth, maxScreenHeight - (r.mapScale - r.snowBiomeTop - f))
            ...
            if (r.mapScale - d <= maxScreenWidth) {
                ...
                ve.fillRect(r.mapScale - d, tmpY, maxScreenWidth - (r.mapScale - d), maxScreenHeight - tmpY)
            }
            ...
            if (r.mapScale - f <= maxScreenHeight) {
                ...
                ve.fillRect(tmpX, r.mapScale - f, (maxScreenWidth - tmpX) - tmpMin, maxScreenHeight - (r.mapScale - f));
            }
            ...
            for (let a = 0; a < X.length + W.length; ++a) {
                ...
                if (U.visible) {
                    ...
                    if (10 != U.skinIndex || U.isAlly) {
                        const shameCounter = menu.getModelActive("shame-indicators") && menu.getModelActive("shame-counter")
                        const team = U.team ? "[" + U.team + "] " : ""
                        const nicknameValue = team + (U.name || "")
                        const shameCounterValue = (shameCounter ? `  ${U.shameCount || 0}` : "")

                        if ("" != v && menu.getModelActive("nickname")) {
                            let offsetX = menu.getModelValue("nickname-offset-x")

                            menu.getModelActive("nickname-float-left") && (offsetX = -menu.getModelValue("nickname-offset-x"))
                            ...
                            const nicknameWidth = ve.measureText(nicknameValue).width

                            ve.strokeText(nicknameValue, U.x - d + offsetX, U.y - f - U.scale - r.nameY + offsetY)
                            ve.fillText(nicknameValue, U.x - d + offsetX, U.y - f - U.scale - r.nameY + offsetY)

                            ve.fillStyle = menu.getModelValue("shame-counter-color")
                            ve.textAlign = "left"

                            if (U.isPlayer) {
                                ve.strokeText(shameCounterValue, U.x + nicknameWidth / 2 + (1 == U.iconIndex ? r.crownIconScale / 2 + r.crownPad / 2 : 0) - d + offsetX, U.y - f - U.scale - r.nameY + offsetY)
                                ve.fillText(shameCounterValue, U.x + nicknameWidth / 2 + (1 == U.iconIndex ? r.crownIconScale / 2 + r.crownPad / 2 : 0) - d + offsetX, U.y - f - U.scale - r.nameY + offsetY)
                            }

                            if (U.isLeader && Ci.crown.isLoaded) {
                                const b = r.crownIconScale

                                k = U.x - d - b / 2 - ve.measureText(nicknameValue).width / 2 - r.crownPad

                                ve.drawImage(Ci.crown, k + offsetX, U.y - f + offsetY - U.scale - r.nameY - b / 2 - 5, b, b)
                            }
                            ...
                            if (1 == U.iconIndex && Ci.skull.isLoaded) {
                                ...
                                ve.drawImage(Ci.skull, k + offsetX, U.y - f + offsetY - U.scale - r.nameY - b / 2 - 5, b, b)
                            }
                        }
                        ...
                        if (menu.getModelActive("attack-animation") && U.active && U.alive && U.isPlayer) {
                            const color = U.isAlly ? "#8ecc51" : "#cc5151"
                            const magic = magicFactory(U.x, U.y, (window.weaponsConfig[U.weaponIndex || 0].range / 1.85), U)
                        ...
                        if (U.isPlayer) {
                            if (U.alive && U.active) {
                                if (U.y <= r.snowBiomeTop) {
                                    U.biomeColor = "#a2c4ec"
                                } else if (U.y >= (r.mapScale / 2) - (r.riverWidth / 2) && U.y <= (r.mapScale / 2) + (r.riverWidth / 2)) {
                                    U.biomeColor = "#486589"
                                } else if (U.y > r.snowBiomeTop && U.y < r.mapScale - r.snowBiomeTop) {
                                    U.biomeColor = "#8cb337"
                                } else {
                                    U.biomeColor = "#a08e3b"
                                }

                                if (menu.getModelActive("movement-tail") && menu.getModelActive("movement-tail-all-players")) {
                                    const scale = menu.getModelValue("movement-tail-scale")

                                    for (let i = 0; i < Math.floor(U.moveSpeed); i++) {
                                        particles.create("movement-tail", U.x, U.y, Math.random() * scale + 1, U.biomeColor, Math.random() * 2 + 1, 600)
                                    }
                                }
                                ...
                                if (U.sid !== A.sid) {
                                    ...
                                    const offset = Math.min(distance - A.scale, A.scale * 4)
                                    const arrowX = A.x + offset * Math.cos(angle)
                                    const arrowY = A.y + offset * Math.sin(angle)
                                    const color = U.isAlly ? menu.getModelValue("tracers-color-ally") : menu.getModelValue("tracers-color-enemy")
                                    const dashLine = menu.getModelActive("tracers-players-dashline")
                                    const arrowWidth = 8

                                    if (menu.getModelActive("tracers-to-players")) {
                                        if (menu.getModelActive("tracers-players-use-arrows")) {
                                            drawArrow(arrowX, arrowY, arrowWidth, color, angle)
                                        } else {
                            ...
                            const arrowX = A.x + offset * Math.cos(angle)
                            const arrowY = A.y + offset * Math.sin(angle)
                            const color = menu.getModelValue("tracers-color-animal")
                            const dashLine = menu.getModelActive("tracers-animals-dashline")
                            const arrowWidth = 8

                            if (menu.getModelActive("tracers-to-animals")) {
                                if (menu.getModelActive("tracers-animals-use-arrows")) {
                                    drawArrow(arrowX, arrowY, arrowWidth, color, angle)
                                } else {
                                    drawTracer(U.x, U.y, color, dashLine)
                                }
                        ...
                        if (U.health > 0) {
                            function renderBar({ width, innerWidth, xOffset, yOffset, color }) {
                                ...
                                const y = U.y - f + U.scale + r.nameY + (yOffset || 0)
                                const height = 17
                                const radius = 8

                                ve.save()
                                ve.fillStyle = nt
                                ve.roundRect(x - r.healthBarPad, y, 2 * width + 2 * r.healthBarPad, height, radius)
                                ve.fill()

                                ve.fillStyle = color
                                ve.roundRect(x, y + r.healthBarPad, 2 * width * innerWidth, height - 2 * r.healthBarPad, radius - 1)
                                ve.fill()
                                ve.restore()
                            }
                            ...
                            if (U.isPlayer && menu.getModelActive("reload-bars")) {
                                menu.getModelActive("reload-bars-primary") && U.updatePrimaryReload()
                                menu.getModelActive("reload-bars-secondary") && U.updateSecondaryReload()

                                const color = U.isAlly ? menu.getModelValue("reload-bars-color-ally") : menu.getModelValue("reload-bars-color-enemy")

                                if (menu.getModelActive("reload-bars-primary")) {
                                    renderBar({
                                        width: r.healthBarWidth / 2 - r.healthBarPad / 2,
                                        innerWidth: U.primaryReloadCount || 1,
                                        color: color,
                                        get xOffset() {
                                            return -(this.width + r.healthBarPad) * Number(menu.getModelActive("reload-bars-secondary"))
                                        },
                                        yOffset: -r.nameY / 2
                                    })
                                }
                                ...
                                if (menu.getModelActive("reload-bars-secondary")) {
                                    renderBar({
                                        ...
                                        color: color,
                                        get xOffset() {
                                            return (this.width + r.healthBarPad) * Number(menu.getModelActive("reload-bars-primary"))
                                        },
                                        yOffset: -r.nameY / 2
                                    })
                                }
                        ...
                        if (U.isPlayer && menu.getModelActive("player-health-text")) {
                            const x = U.x - d
            ...
            if (A?.alive && A?.active) {
                ...
                if (menu.getModelActive("movement-tail") && !menu.getModelActive("movement-tail-all-players")) {
                    ...
                    for (let i = 0; i < Math.floor(A.moveSpeed); i++) {
                        particles.create("movement-tail", A.x, A.y, Math.random() * scale + 1, A.biomeColor, Math.random() * 2 + 1, 600)
                    }
                }
            }
                ...
                if (A && A.alive) {
                    ...
                    if (menu.getModelActive("minimap-biomes")) {
                        function getBiomePosition(position, diviser = 1) {
                            return position / r.mapScale * ((Ge.width + Ge.height) / 2 / diviser)
                        }
                        ...
                        Ke.fillStyle = "#91b2db"
                        Ke.fillRect(0, getBiomePosition((r.mapScale / 2) - 362), Ge.width, getBiomePosition((r.mapScale / 2) + 362, 10))

                        Ke.fillStyle = "#dbc666"
                        Ke.fillRect(0, getBiomePosition(r.mapScale - 2400), Ge.width, Ge.height)
                        Ke.restore()
                    }
...
, function(e, t) {
    e.exports = function(e) { // Building
        ...
        this.updateItemCount = function(isRemove) {
            ...
            const limit = window.inSandbox ? Math.max(3 * this.group.limit, 99) : this.group.limit

            itemCount.innerText = `${itemsCount[this.group.id] + (isRemove ? -1 : 0)}/${limit}`
        }
        ,
    ...
    e.exports = function(e, t, i, l, h, u, d, f, p, g, m, y, k, w) {
        ...
        this.updateHealthAnim = function() {
            ...
            if (this.isHealing) {
                ...
                if (this.health >= (this.oldHealth + this.lossHealth)) this.resetHealthAnim()
            } else {
                this.health -= amount
        ...
        this.startAnim = function(e, t) {
            if (window.menu.getModelActive("reload-bars") && window.menu.getModelActive("reload-bars-primary")) {
                this.animActive = true
                this.primaryReloadMax = this.primaryReload = p.weapons[this.weaponIndex].speed
            }
        ...
        this.updateSecondaryReload = function(item) {
            if (!window.menu.getModelActive("reload-bars") || !this.isSecondaryReloadActive) return
        ...
        this.canSeePoint = function(e) {
            ...
            return t <= window._maxScreenWidth / 2 * 1.3 && n <= window._maxScreenHeight / 2 * 1.3
        }
        ,
