// ==UserScript==
// @name         private Melon-Mod v34(final ver)
// @namespace    nothing
// @version      v34
// @description  no
// @author       Scoper - RaZoshi
// @match        *://moomoo.io/*
...
`
<body>
<center> <h1 class="ZM09"">SwareMod</h1> </center>
<br>
...
getElement.style.backgroundColor = "#8ad618";
getElement.style.color = "#000000";
document.getElementById('enterGame').innerHTML = 'Start';
document.getElementById('loadingText').innerHTML = '';
document.getElementById('nameInput').placeholder = "SwareMod";
