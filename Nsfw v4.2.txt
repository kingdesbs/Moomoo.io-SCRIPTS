...
// @version     2
// @description
// @author      Gigachad0691,Chicken,Nezart
// @match       *://moomoo.io/*
// @match       *://sandbox.moomoo.io/*
// @match       *https://moomoo.skids.info/*
// @icon        https://media.discordapp.net/attachments/1075163365200101417/1075395749946327100/wOlcWHWRgvwhgAAAABJRU5ErkJggg.png?width=300&height=300
...
document.getElementById('enterGame').innerHTML = 'Rekt all';
document.getElementById('loadingText').innerHTML = 'Nsfw 2.0v';
document.getElementById('nameInput').placeholder = "Ṋ̷̨̡̨̨̘̤̠̻̼̲͍̼̣͈͓̥̻̙̠̫̦̩̦̲͚̫̩̻́̍̓́̿̋̑̎̈́͊͐̎͑͊̊̃͒̌̐͑̍̓̓͊̎͊͂̏͆͗͛̀̔̑͝ş̴̧̛̩̫̪̞̫̭͕̤̮̣͙͕͇͍̞̠͓̼̠̝͇̜̲̰̪̱́̏͛̀̇̃͆̀͗̅́͋̽͒̇̀̏̄̃̏͐̓͘̕͘͜͜͠͠͠ͅf̵̡̡̨̡̛͚̟̮̳̳̹̘̱̺͚̩͔̗̙̗̼͈͓̣̬̙̥͙̠͕͇̞̰͈̮̥͉͂̅͒̍̑͂̀̈́̂̋̎̊̍̊̇̽̒̐̏̓͆̋̾͌̏̂̏͛̀́̏͒̂͐͛̚͘͘͝͝w̶̡̢̨̰̮̩̦̤͔̖̼̼̲̜̩̱̫̼̘̙̼̦̹̖͉̽̾͒̌̄̓̓͂͗̽̌̍̐̐̑͋̀̅͋̏͐͐̑̃̒͒̈́̓̃̊̈͂̎̃̑͆̎̆̂́̂͆͋̕͘̚ͅ";
document.getElementById('diedText').innerHTML = 'Die with the best mod???';
document.getElementById('gameName').innerHTML = 'sex';
document.getElementById("leaderboard").append ('Nsfw');

setInterval(() => {
    setTimeout(() => {
        document.getElementById("gameName").innerHTML = "NSFW"
        setTimeout(() => {
            document.getElementById("gameName").innerHTML = "CLIENT"
            setTimeout(() => {
                document.getElementById("gameName").innerHTML = "NSFW CLIENT"
                setTimeout(() => {
                    document.getElementById("gameName").innerHTML = "ON"
                    setTimeout(() => {
                        document.getElementById("gameName").innerHTML = "THE"
                        setTimeout(() => {
                            document.getElementById("gameName").innerHTML = "TOP"
                            setTimeout(() => {
                                document.getElementById("gameName").innerHTML = "BY"
                                setTimeout(() => {
                                    document.getElementById("gameName").innerHTML = "FAWORKA"
                                    setTimeout(() => {
                                        document.getElementById("gameName").innerHTML = "SHADOW"
                                        setTimeout(() => {
                                            document.getElementById("gameName").innerHTML = "GIGACHAD"
                                            setTimeout(() => {
                                                    document.getElementById("gameName").innerHTML = "NEZART"
                                                }, 1000);
                                            }, 1000);
                                        }, 1000);
                                    }, 1000);
...
setInterval(() => {
    setTimeout(() => {
        document.getElementById('chatBox').placeholder = "Nsfw";
        setTimeout(() => {
            document.getElementById('chatBox').placeholder = "On";
            setTimeout(() => {
                document.getElementById('chatBox').placeholder = "The";
                setTimeout(() => {
                    document.getElementById('chatBox').placeholder = "Top";
                }, 100);
            }, 100);
        }, 100);
    }, 100);
...
, function(e, t, n) {
    ...
    <h1 style="font-size: 24px; margin-left: 10px;">Nsfw v2.0</h1>
    <center>
    ...
    Ne.style.backgroundImage = "url('https://media.tenor.com/LBJv3bYrmBsAAAAC/cat-dancing.gif')";
        ...
        function() {
            ...
            a = 0; a < W.length + Y.length; ++a)
                if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                    var w = (_.team ? "[" + _.team + "] " : "") + (_.isPlayer && _ != R ? "["+_.primary.id+"/"+_.secondary.id+"/"+(_.turret==1?1:0)+"] " : "") + ((_ == R && toggles.streamermode() ? "unknown" : _.name) || "");
                    if ("" != w) {
