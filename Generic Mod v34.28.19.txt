...
// @icon        https://i.pinimg.com/736x/e5/a5/e3/e5a5e326c1f6c4215d32da54c4c593dc.jpg
...
, function(e, t, n) {
    (function(t) {
        ...
        e.exports.nameY = 34,
        e.exports.skinColors = ["#bf8f54", "#cbb091", "#896c4b", "#fadadc", "#ececec", "#c37373", "rgba(0,0,0,0)", "#ecaff7", "#91B2DB", "#8bc373"],
...
, function(e, t, n) {
            ...
            r.connect(c, (function(e) {
                ...
                function() {
                    for (var e = 0; e < jn.length; ++e) {
                        ...
                        ,
                        t.src = jn[e] == "crosshair" ? "https://www.pngmart.com/files/22/Scope-PNG-Pic.png" : ".././img/icons/" + jn[e] + ".png",
                        Rn[jn[e]] = t
                    }
                }(),
    ...
    <button id="cls" style="cursor: pointer;">CloseMenu</button><br>
    ...
    ${generateNewConfig("Config: ", "configType", [
        ...
        [19, "OneTickBoost", "checked", "OneTickBoost"],
    ...
    ${generateNewToggle("Recomented Functions: ", "tryhard", "")}<br>
    ${generateNewToggle("Auto Hit Sync (Dont Use With Bullspam): ", "autohitsync", "")}<br>
    ...
    document.getElementById("tryhard").addEventListener("change", () => {
        if(document.getElementById("tryhard").checked) {
            ...
            element("smoothbar").checked = true;
...
$("#mobileDownloadButtonContainer").hide();
            ...
            !function(n) {
                s.generateElement({
                    ...
                    children: [s.generateElement({
                        ...
                        text: t + ". " + ("" != e[n + 1] ? e[n] == R.sid && toggles.streamermode() ? "Generic-User" : e[n + 1] : "unknown")
                    }), s.generateElement({
                        class: "leaderScore",
    ...
    var newHatImgs = {
        7: "https://cdn.discordapp.com/attachments/1108350303968964638/1108352272783638539/imageedit_23_7651209958.png",
        15: "https://i.imgur.com/YRQ8Ybq.png",
        11: "https://cdn.discordapp.com/attachments/1108350303968964638/1108353244335443969/imageedit_35_4132849015.png",
        12: "https://cdn.discordapp.com/attachments/1108350303968964638/1108354901697904710/imageedit_46_3461599639.png",
        40: "https://cdn.discordapp.com/attachments/1108350303968964638/1108351495046451250/imageedit_16_9773283699.png",
        26: "https://cdn.discordapp.com/attachments/1104859039571120190/1105230847310835822/Hat_16.webp",
        6: "https://cdn.discordapp.com/attachments/1108350303968964638/1108354403154534440/imageedit_44_6119232470.png",
    };
    var newAccImgs = {
        18: "",
    };
    var newWeaponImgs = {
         "hammer_1": "https://cdn.discordapp.com/attachments/1108350303968964638/1108350691732377640/imageedit_5_3841164108.png",
         "samurai_1": "https://cdn.discordapp.com/attachments/1108350303968964638/1108355222511829013/imageedit_49_9686172828.png",
        "great_hammer_1": "https://cdn.discordapp.com/attachments/1108350303968964638/1108355656081231943/imageedit_52_8981025293.png",
    };
    ...
    function e() {
        ...
        function() {
         ...
         for(let i = 0; i < N.length; i++) {
                ...
                _.currentHealth > 0 && _.active && _.currentHealth < _.health && bhp == true && (
                    ...
                    be.roundRect((_.x + _.xWiggle) - f - o.healthBarWidth / 2 - o.healthBarPad,( _.y + _.yWiggle) - d - 8.5, o.healthBarWidth + 2 * o.healthBarPad, 17, 8),

                    be.fill(),

                    be.fillStyle = "#000000",

                    be.roundRect((_.x + _.xWiggle) - f - o.healthBarWidth / 2, ( _.y + _.yWiggle) - d - 8.5 + o.healthBarPad, o.healthBarWidth * (_.currentHealth / _.health), 17 - 2 * o.healthBarPad, 7),
            ...
            a = 0; a < W.length + Y.length; ++a)
                if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                    var w = (_.team ? "[" + _.team + "] " : "") + (_.isPlayer && _ != R ? "["+_.primary.id+"/"+_.secondary.id+"/"+(_.turret==1?1:0)+"] " : "") + ((_ == R && toggles.streamermode() ? "Generic-User" : _.name) || "");
                    if ("" != w) {
                    ...
                    if(_ == R) {
                        ...
                        be.lineWidth = 6;
                        be.strokeText(texs, _.x - f, _.y - d + _.scale + o.nameY + (-68));
                        be.fillText(texs, _.x - f, _.y - d + _.scale + o.nameY + (-68));
                    ...
                    if(_.isPlayer) {
                        ...
                        if(toggles.reloadbars()) {
                            ...
                            be.fill();
                            be.fillStyle = _.secondary.reload == 1 ? "#ffffff" : "hsl(" + 360 * _.secondary.reload+ ", 50%, 60%)";
                            ...
                            be.fill();
                            be.fillStyle = _.primary.reload == 1 ? "#ffffff" : "hsl(" + 360 * _.primary.reload+ ", 50%, 60%)";
...
for (var mn = 0; mn < stycross.length; mn++) {
    ...
    if(stycross[mn] == "Default (Crosshair)") { optioner.value="url('https://www.pngmart.com/files/22/Scope-PNG-Pic.png'), auto"; }
