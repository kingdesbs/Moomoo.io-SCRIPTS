...
// @author        Oman#1362
// @match        ://*.moomoo.io/*
// @icon    https://cutewallpaper.org/26/beautiful-magical-gif-wallpaper/best-magical-objects-gifs-gfycat.gif
// @grant        none
//@versoin         1
...
/////////////////////////////////
 ...
 var newValue = prompt("Have  fun", "killing all Or not?");
...
$("body").append(`
          <div id="modmenu" style="display: block;
           ...
           background: linear-gradient(#4815AA,#4815AA,);
           position: absolute;
           left: 30px;
           top: 30px;
           width: 375px;">
...
$("#modmenu").append(`
        ...
        <div id="textHelp" style="border-radius:20px;"> <legend
           style = "font-size: 21px; text-align: center;"><br>invis v1:</legend>
           <div style="color: rgb(255, 255, 255);font-size: 15px; padding-left: 25px; max-height: 235px;">
           <br>

                          ${generateNewConfig("types", "types", [
    [0, "invis"],
    [0, "Ae86"],
])}<br>


                      ${generateNewList("Types ", "Uwu", [
    [0, "Rev3"],
    [0, "invis"],
])}<br>

           ${generateNewList("Visaluse: ", "chatType", [
    [0, "invis v1"],
])}
 ...
 ${generateNewToggle("invis Mode :", "inviskmode", )}<br>


`);
//open close menu here
...
// @author       Oman
// @match        ://*.moomoo.io/*
// @icon         https://media.discordapp.net/attachments/1120368217664270456/1120740561062723666/Cigarette.webp
// @grant        none
// ==/UserScript==
...
document.getElementById("mainMenu").style.backgroundImage = "url('https://tenor.com/view/lord-jesus-christ-sacred-heart-savior-gif-13610800')";
document.getElementById('enterGame').innerHTML = 'Invis says kill all';
document.getElementById('loadingText').innerHTML = 'Invis op';
document.getElementById('nameInput').placeholder = "invis v1";
document.getElementById('diedText').innerHTML = '';
document.getElementById("gameName").innerHTML = '';
document.getElementById("leaderboard").append ('Invis');
document.getElementById("leaderboard").style.color = "#66000000"; document.getElementById("leaderboard").style.font = "";
document.getElementById("gameName").style.font = "Tw Cen MT"
                           setInterval(() => {
                           setTimeout( () => {
                           document.getElementById("gameName").innerHTML = "Invis v1"
                           setTimeout( () => {
                           document.getElementById("gameName").innerHTML = "invis v2"
                           setTimeout( () => {
                           document.getElementById("gameName").innerHTML = "invis v3"
                           setTimeout( () => {
                           document.getElementById("gameName").innerHTML = "invis v4"
                           setTimeout( () => {
                           document.getElementById("gameName").innerHTML = "invis v5"
                           setTimeout( () => {
                           document.getElementById("gameName").innerHTML = "invis v6"
                           }, 50);
                           }, 100);
                           }, 200);
                           }, 300);
...
$('.menuHeader').css({'color': '#00000'});

$('#killCounter').css({'color': '#00000'});

$('#diedText').css({'background-color': 'rgba(0, 0, 0, 0)'});

$('#gameCanvas').css({'background-color': '#00000'});

$('#allianceButton').css({'color': '#0000'});

$('#storeButton').css({'color': '#0000'});

$('#chatButton').css({'color': '#00000'});
...
var webpackModules = [function(e, t, i) {
    (function(t) {
        e.exports.maxScreenWidth = 1920,
            ...
            e.exports.nameY = 34,
            e.exports.skinColors = ["#66000000", "#0000FF", "#0000FF", "#0000FF", "#0000FF", "#0000FF", "#66000000", "#66000000", "#66000000", "#66000000"],
    ...
    document.getElementById("pingDisplay")), Te = document.getElementById("shutdownDisplay"), Me = document.getElementById("menuCardHolder"), Ce = document.getElementById("guideCard"), Pe = document.getElementById("loadingText"), Ee = document.getElementById("gameUI"), Oe = document.getElementById("actionBar"), Be = document.getElementById("scoreDisplay"), je = document.getElementById("foodDisplay"), Ae = document.getElementById("woodDisplay"), De = document.getElementById("stoneDisplay"), Ue = document.getElementById("killCounter"), Re = document.getElementById("leaderboardData"), Le = document.getElementById("nameInput"), ze = document.getElementById("itemInfoHolder"), _e = document.getElementById("ageText"), Fe = document.getElementById("ageBarBody"), He = document.getElementById("upgradeHolder"), Ve = document.getElementById("upgradeCounter"), qe = document.getElementById("allianceMenu"), We = document.getElementById("allianceHolder"), Xe = document.getElementById("allianceManager"), Ge = document.getElementById("mapDisplay"), Ne = document.getElementById("diedText"), Ye = document.getElementById("skinColorHolder"), Ke = Ge.getContext("2d");
                          ...
                          , at = [{
                              name: "Oman",
                              link: "https://discord.gg/ppsSg6m9"
                          }, {
                              name: "Oman",
                              link: "https://discord.gg/ppsSg6m9"
                          }, {
                          ...
                          function Mt() {
                              if (St[0]) {
                                  ...
                                  o.removeAllChildren($e),
                                      ...
                                      o.generateElement({
                                      class: "notifButton",
                                      html: "<i class='material-icons' style='font-size:28px;color:#00000,;'>&#00000;</i>",
                                      parent: $e,
                                      onclick: function() {
                                          jt(0)
                                      },
                          ...
                          window.addEventListener("keydown", o.checkTrusted((function(e) {
                              ...
                              27 == t ? Gt() : A && A.alive && di() && (li[t] || (li[t] = 1,
                                                                                  80 == t ? autoGrind.toggle = !autoGrind.toggle : 81 == t ? placer.itemIndex = 0 : 86 == t ? placer.itemIndex = 2 : 78 == t ? autoMill.toggle = !autoMill.toggle : 70 == t ? placer.itemIndex = 4 : 72 == t ? placer.itemIndex = 5 : 69 == t ? s.send("7", 1) : 67 == t ? toggleSing() : 88 == t ? (A.lockDir = A.lockDir ? 0 : 1,
                                                                                                                              s.send("7", 0)) : null != A.weapons[t - 49] ? yi(A.weapons[t - 49], !0) : null != A.items[t - 49 - A.weapons.length] ? yi(A.items[t - 49 - A.weapons.length]) : 81 == t ? yi(A.items[0]) : 66 == t ? (autoOneTick.toggle = !autoOneTick.toggle, !autoOneTick.toggle && (mf(null))) : 82 == t ? autoInstakill.toggle = !autoInstakill.toggle : hi[t] ? gi() : 32 == t && (j = 1,
        fi())))
                          }
                                                                            ))),
                          ...
                          function Ti(e) {
                              ...
                              if(n && cdf(A, n) < 200){
                                  if(enemies.length){
                                      ...
                                      if(!lastWorked.autoPlacer && dist < 300){
                                          if(dist <= 300){
                                              place(A.items[2], caf(A, enemy));
                                              place(A.items[2], dir);
                                          }
                                          lastWorked.autoReplacer = true;
                                          setTimeout(()=>lastWorked.autoReplacer = true, 300);
                                          if(dist < 200){
                                      ...
                                      if(t){
                                          for(let h of N){
                                              if(!h.foundHitter && h.active && tick - h.lastWiggle <= oT && cdf(h, U) - h.scale <= weapon.range && utils.getAngleDist(U.d2, caf(U, h)) <= Math.PI/2.6){
                                                  ...
                                                  /*if(cdf(A, h) < 200  && h.health <= ){
                                   setTimeout(()=>{
                                       pf(A.items[3], caf(A, h));
                                   }, weapon.speed + oT*1.5);
                               }*/
                                              }
                                          }
                          ...
                          function Qi(e) {
                              ...
                              if (!n) {
                                  ...
                                  if (a.translate(s.width / 2, s.height / 2),
                                      ...
                                      2 != e.type && 3 != e.type || (a.fillStyle = 2 == e.type ? 2 == t ? "#938d77" : "#939393" : "#939393",
                              ...
                              if (!i || t) {
                                  ...
                                  if (s.translate(n.width / 2, n.height / 2),
                                      ...
                                      s.fillStyle = "#a5974c",
                                          ...
                                          s.fill(),
                                          s.stroke(),
                                          s.fillStyle = A && e.owner && e.owner.sid != A.sid && !isAlly(A, e.owner.sid) ? "#FF0000" : it,
                ...
                sn(0, 0, .65 * e.scale, 20, 4, s, !0)) : "teleporter" == e.name && (s.fillStyle = "#7e7f82",
                              ...
                              if(U = findP(e)){
                                  ...
                                  if(A == U){
                                      ...
                                      if(enemies.find(z => cdf(z, A) < 300) && ((a >= -17.7 && a <= -10) || a <= minDamage) && a != -50 * (A.skin?.dmgMult || 1)){
                                          if(A.shameCount <= 3){
                                              for(let v = 0;v<Math.ceil(50/l.list[A.items[0]].consume);v++) pf(A.items[0]);
                                          } else {
                                              equiper++;
                                              forceEquip = [6, 13];
                                              ef(forceEquip[0], 0);
                              ...
                              run: function(other, damage) {
                                  ...
                                  if (A.weapons[0]) {
                                      if (ham && A.canShot(other, 1)) {
                                          ...
                                          if (priDamage + secDamage + turDmg < health) return true;
                                          autoImg.autoInstakill.target = other.sid;
                          ...
                          var autoImg = {
                              autoOneTick: {
                                  image: "https://w7.pngwing.com/pngs/130/563/png-transparent-reticle-telescopic-sight-sniper-barrett-m82-hezbollah-sniper-scope-computer-wallpaper-assault-rifle-sniper-thumbnail.png",
                                  target: null,
                              },
                              xd: {
                              ...
                              autoInstakill: {
                                  image: "https://cdn.discordapp.com/attachments/1001384433078779927/1041105230374391878/crorrrrrrrrrshairlololol.png",
                                  target: null,
                              },
                          };
                              ...
                              if (autoMill.toggle) {
                                  ...
                                  if(autoPlacer.count > 3){
                                      ...
                                      if(!lastWorked.autoReplacer){
                                          ...
                                          setTimeout(()=>lastWorked.autoPlacer = true, 300);
                                          if(A.inTrap){
                                              let ignore = 0;
                        ...
                        <div style="font-size: 17px;">
                         FPS: ${window.pingTime}<br>
                        Insta R: ${autoInstakill.toggle}<br>
                        OneTick B: ${autoOneTick.toggle}<br>
                        Auto grind P: ${autoGrind.toggle}<br>
                        Windmills N: ${autoMill.toggle}<br>
                        </div>`;
                      }
           ...
           document.getElementById("songs").add(option);
                      ...
                      function Tn() {
                          var e = Date.now() - In;
                          window.pingTime = e,
                              Ie.innerText = "FPS 60 ÜSTÜ Kötü: " + e + " ms"
                      }
                      function Mn() {
                          In = Date.now(),
                              s.send("pp")
            ...
            ve.fillRect(0, r.mapScale - r.snowBiomeTop - f, ae, re - (r.mapScale - r.snowBiomeTop - f)));
                              ...
                              for (let a = 0; a < X.length + W.length; ++a)
                                  if ((U = X[a] || W[a - X.length]).visible) {
                                      ...
                                      shameImage.src = "https://images.unsplash.com/photo-1556388275-bb5585725aca?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8c21va2V8ZW58MHx8MHx8fDA%3D&w=1000&q=80";
                                      ...
                                      U.isPlayer && (b = 48,
                                                     ...
                                                     ve.fillStyle = U.reloads[U.weapons[0]] ? "#8800ff" : "#0000ff",
                                                     ...
                                                     ve.fill(),
                                                     k = U.y - f + U.scale + r.nameY + r.healthBarPad - 17 + r.healthBarPad,
                                                     ve.fillStyle = U.weapons[1] && U.reloads[U.weapons[1]] ? "#8800ff" : "#0000ff",
                                      ...
                                      U.health > 0 && (ve.fillStyle = nt,
                                                       ...
                                                       ve.fill(),
                                                       ve.fillStyle = U == A || U.team && U.team == A.team ? "#8800ff" : "#000000",
