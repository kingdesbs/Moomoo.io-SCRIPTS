...
// @version     7.8
// @description
// @author      SVH,Davidlehene,Inglaberto45
// @match       *://moomoo.io/*
// @match       *://sandbox.moomoo.io/*
// @match       *https://moomoo.skids.info/*
...
// document.getElementById('downloadButtonContainer').innerHTML = '</iframe><iframe width="420px" height="236.25px" src="http://icecast3.play.cz/evropa2-128.mp3"></iframe>';
 ...
 document.getElementById("mainMenu").style.backgroundImage = "url('https://upload.cc/i1/2022/12/11/A3vmCc.png')";
document.getElementById('enterGame').innerHTML = 'Enter Game';
document.getElementById('loadingText').innerHTML = 'Loding please wait...';
document.getElementById('nameInput').placeholder = "";
document.getElementById('diedText').innerHTML = '';
document.getElementById('gameName').innerHTML = 'P911';
document.getElementById("leaderboard").append ('Gold Score');
document.getElementById("leaderboard").style.color = "#000000"; document.getElementById("leaderboard").style.font = "40px ink free";
document.getElementById("gameName").style.font = "Tw Cen MT"
                           setInterval(() => {
                           setTimeout( () => {
                           document.getElementById("gameName").innerHTML = "Ḟ̸͈͇͎̻͚̳̔̏̅̊̓̍̀̈́̍̎͊i̴̤̲̎̎̽̓̓̿̽͑̎̈́͗͛̋̃r̴̡̨̛̫͚̥̯̒̑̅̀́͒̑e̴̺̥̤̜͙̤̥̐̾̋̅̈͐̔̋͊̂̕͜͝ͅC̷̳̹͙͕̬̰̘̮͙̋́̆̆̐̈̇̕ĥ̴͎͕͖͙̤͓̪̈́̈̈́̂̿̒̈͠͝ͅi̸̜̰̰̻̜̼͙̖̟̻̓̾̅͘͜͝p̴͚͓̥̠̅͜ͅͅ"
                           setTimeout( () => {
                           document.getElementById("gameName").innerHTML = "F̷̧̛̙̗̹̪̬̠͎̝̖̳̉͆͒̀̂̆̃̑̀͋̓͠͠ī̸̡̡̼̟̗̭̹̣̗̬̔̂̇͜r̴̢̢̗̼̹̲̺͈̟̱͉̀̀͘̕e̷͖̎͌̍̆́̓͒́͌̃̑̃͛̿͝C̶̨̨̡̙͓̝͕̫̜̒͝ͅḩ̶̢̣̮̺̣͙̪͓̤̩̲͖̝̯̽̈́̽̉̐͒͐͆ĩ̴̡̻̬̹̬̹̼̭̣̆̎́̓̋̈́̅͌̚̕̚͝p̸̡̛͉̻̝̥̰͔̪̺̙̲̑͊̚ͅͅ"
                           setTimeout( () => {
                           document.getElementById("gameName").innerHTML = "F̸̧̦͈̫̠͖͔͉̹̭̠͔́̅̇̋̾ī̷̥̋̈̈́͑̀̏͆̄̀r̵̩̱̺̺̮̈̄̍͛̈́̄̅e̵̼͇̼̼̽͐́C̶̡̛͓̩̽̍̂͑h̸̫̠͎͈̝̱̭̥̰̠̰̏̀̄̆͌̒̌̐̊̿̈͘͜͠i̷̥̭͂̃̒͛̀͒̓̊̆̅́͒̓̇̕p̶̡̮̮̖͖̳̺̮̟̦̤͚̃̽"
                           setTimeout( () => {
                           document.getElementById("gameName").innerHTML = "F̸̨̦̫̬̭̺̠̣̭͓̝̰͕͖̺͈̅̈́ȉ̷̩͚̊̊̄̾͒̕͝ṟ̸̢̢̧̡̫̹̦̹͓͖̘͎̟̘̞̥̦̉̓̈́̔̑̀̔̂̈́̇̃͜ë̷̜͕̯̯̺͉̳̦́̄̚͜Ć̷̛̯͙͔̜̂͛̇͋̃̆̊̓̒̓̿̒̅̆̚̕͝͝h̵̙̃̈̂i̸̙̬͛̀̈́͐͐p̷̢͕͚̹͖̦̫̰͚̻̲͔͕͒̾̓̈́͝"
                           setTimeout( () => {
                           document.getElementById("gameName").innerHTML = "F̸̢͚͔͔͚͔͈͇̈́̎͗̌̒̒́į̸̳͕̟̦̭̥͍͕͙̻̪̣̞̟̻̘̤̆̋̈́͑̈́̆̎̅̑͝͠ͅr̸̡̩̳̲͍̭̱̙̠̹͛͜ê̴̥̩̈̇̇̏͛̀̄̈͆̒͘͠C̸̢̛̛̩͍̤͔̗͎̰̪̗͖̹͉̽̒̄̇̿͒͆͋̒̿͗̓͛̈́̑̅͠͝ͅh̸̩̝̗̦̯͍̤̭̝̻͈̞̹̞̪͕̅̔́̆̍̈́̑̏̓͂̽͛̑́̀̕͘̕͜͝ȋ̸̢͖̆̃̀́̿͂̌͋́̊̔p̷̨͔̮̫͇̺̟̬͙̮̟̮̩̠̬̭̣̰̦̬͘ͅ"
                           setTimeout( () => {
                           document.getElementById("gameName").innerHTML = "F̷̧̯̺̠̰̭̖͔̭̈́͋̇̏̾͝i̷̧̡͓̤̗͕̳̱̦͇͉̩̣̖͕͓̭̮̘̲̪͍̕͠ͅr̵̡̨̛̛̺͇̖̲͚͙̦̖̞̫̼̩̹̮̯̯̣̗͖̯̘͓̗̅͗̓̂̿̓̄͑̽͂̓̔̎͂́̀̓̐̓̀͗ͅͅͅę̴̡̲͔̙̤̪͕̻̦̥̹̩̦̬̟̭̙̠̞̘̪̣̺̻̭͇̆̊͗́̀̽̍̀͛̾͜ͅͅC̵̝̬̺̟̥͖͈̣̪͔̪̝̝̥͎̖͕̩͈͎̼͖͎̩͉̞̣̣͂̈̓͛̽͂̊͛̐͆̆͐͌͝͠͠h̷̡̛͙̳̼̥̭̀̌̀͆͂̓̓͆͊̓̆͆̂̓̊̊̈́̃̌͐͘͘͝͠͝͠į̵̢̨̛͉͖͖͍̜͔̻̰͎͖̘̙͕͚͇̳̟̦̱̥̹̙͉̙̫̆̋̒̈́̂̅̈́̔̒̊̍͆̈́̈́̈́̐̾̊͆̃̀͗͒̂̊̌͠͠͠p̶̢̡̛͖̞͖̠̖̞͉̖͍̳̗͎̠̮̫̰͖͔͇̲̂͌͗̋̒̈́̾͂́̓͗̉̽́́̈́̔̈̚͘͜͠͝"
                           }, 50);
                           }, 100);
                           }, 200);
                           }, 300);
...
, function(e, t, n) {
    ...
    function Tn() {
        ...
        if (!le && r.connected) {
            ...
            r.send(atob("c3A="), {
                name: Le.value,
                moofoll: 1,
                skin: toggles.glitchcolor() ? "constructor" : ae
            });
    ...
    var on, cn, ln = [], ignoreList = [];
    function hn(e, t) {
           (t.includes("mod?")) ? r.send("ch", "NFSW 4.2 REMAKE :)...") : (t.includes("what mo")) && r.send("ch", "nfsw 4.2 remake...");
           (t.includes("fake")) && r.send("ch", "DONT MAKE ME MAD...");
           (t.includes("hi")) && r.send("ch", "GOLDEN SAYD EZ...");
           (t.includes("hel")) && r.send("ch", "GOLDEN SAYD EZ...");
           (t.includes("no")) && r.send("ch", "GOLDEN SAYD EZ...");
           (t.includes("x")) && r.send("ch", "GOLDEN SAYD EZ...");
           (t.includes("X")) && r.send("ch", "GOLDEN SAYD EZ...");
           (t.includes("tf")) && r.send("ch", "GOLDEN SAYD EZ...");
    ...
    <h1 style="font-size: 24px; margin-left: 10px;"> v2.0</h1>
    <center>
    <div style="width: 440px; height: 210px; text-align: left; margin-left: 14px; overflow-y:">
    <button id="antianticheat" style="cursor: pointer;">LPS</button><br>
    ${generateNewToggle("Autoplacer: ", "autoplace", "")}<br>
    ${generateNewList("Autoupgrade: ", "upgradetype", [[0, "DH"], [1, "PH"]])} ${generateNewList("", "sixbuilding", [["tele", "TP"], ["turret", "Turret"], ["block", "Blocker"], ["plat", "Platform"]])} ${generateNewToggle("", "autoupgrade", "")}<br>
    ${generateNewToggle("Auto Bull Spam: ", "autobullspam", "")}<br>
    ${generateNewConfig("Config: ", "configType", [
        [0, "Auto Grind", "", "autogrind"],
        [1, "Texture Pack", "", "texturepack"],
        [2, "Weapon Range", "", "weaponRange"],
        [3, "Auto OneTick", "", "autotick"],
        [4, "Anti Bull", "", "antibull"],
        [5, "Autobreak Trap", "checked", "autobreak"],
        ...
        [10, "Auto Buy", "", "autobuy"],
        [11, "Render Real Dir", "", "realdir"],
        [12, "Anti Trap", "checked", "antitrap"],
        [13, "River Color Skin", "", "glitchcolor"],
        [14, "Smooth Age Bar", "", "smoothbar"],
        [15, "Spike Tick/Sync", "", "spiketick"],
    ...
    ${generateNewToggle("Day/Night Cycle: ", "mapcolor", "")}<br>
    ...
    ${generateNewToggle("Map Ping Sync: ", "teamsync", "")}<br>
    ${generateNewConfig("Bullet Config: ", "bulletType", [
        [0, "Anti Turret Sync", "", "antiTurretSync"],
        [1, "Ranged Anti", "checked", "backUpRAnti"]
    ])}<br>
    ${generateNewToggle("Tryhard Mode: ", "tryhard", "")}<br>
    ${generateNewToggle("Auto Hit (not compatible with autobullspam): ", "autohitsync", "")}<br>
    ${generateNewToggle("Streamer Mode: ", "streamermode", "")}<br>
    ${generateNewList("Healer Speed: ", "healSpeed", [
        [145, "Slow"],
        [111, "Fast"],
        [222, "KH"],
        [1, "How to get clown.exe"]
    ])}<br>
    ${generateNewToggle("Place x4 TP/Turrets: ", "quadTurret", "")}
    <p></p>
    </div>
    </center>
    `;
    ...
    document.getElementById("tryhard").addEventListener("change", () => {
        if(document.getElementById("tryhard").checked) {
            ...
            element("texturepack").checked = true;
            element("weaponRange").checked = true;
        }
    });
    ...
    Ne.style.backgroundImage = "url('https://upload.cc/i1/2022/12/07/v614ln.gif')";
    Oe.style.backgroundPosition = "right 6px center";
...
$("#mobileDownloadButtonContainer").hide();
    ...
    document.getElementById("gameName").innerHTML = "F̶̯̜̋i̸̳̕r̷̲̞̄̾e̶̩̭̾̎C̴̥͉̈̎h̶̞̃̀i̶̩̅p̷̫͝";
    ...
    var audios = [
        ...
        new Audio("https://cdn.discordapp.com/attachments/1075163365200101417/1078092436473139252/y2mate.com_-_Benzz_Je_Mappelle_Music_Video_GRM_Daily_v144P.mp4"),
    ];
    function sendChat(e) {
        let chats = [];
        audios[e].play();
        if(e == 0) {
            ...
            chats=[{chat:"Got the gyaldem shake",delay:0},{chat:"hips in the dance",delay:1000},{chat:"Je m'appelle, man's Benz",delay:2000},{chat:"Got gyal like ten from Paris",delay:3000},{chat:"I can't come France",delay:4000},{chat:"(Ayy, Lucid turn that shit up)",delay:5000},{chat:"ayy",delay:6000},{chat:"Got the gyaldem shake",delay:7000},{chat:"hips in the dance",delay:7500},{chat:"Je m'appelle, man's Benz",delay:8800},{chat:"Got gyal like ten from Parise",delay:10000},{chat:"I can't come France",delay:11000},{chat:"He wan' talk badness",delay:12200},{chat:"on my darg",delay:13000},{chat:"Man a real cash man",delay:13700},{chat:"I don't catch man's darg",delay:15000},{chat:"Flip that, scribble that",delay:16000},{chat:"that on the route, man's off",delay:16400},{chat:"Grip that, fiddle that",delay:17000},{chat:"in the coupe, man's lost",delay:17600},{chat:"Yo, grab the wheel",delay:19000},{chat:"man's lost",delay:20000},{chat:"Got the gyaldem shake",delay:20600},{chat:"hips in the dance",delay:21000},{chat:"Je m'appelle, man's Benz",delay:22700},{chat:"Got gyal like ten from Paris",delay:24000},{chat:"I can't come France",delay:24600},{chat:"He wan' talk badness",delay:26000},{chat:"on my darg",delay:26900},{chat:"Man a real cash man",delay:27500},{chat:"I don't catch man's darg",delay:28000},{chat:"Flip that, scribble that",delay:28900},{chat:"on the route, man's off",delay:30000},{chat:"Grip that, fiddle that",delay:30900},{chat:"in the coupe, man's lost",delay:31900},{chat:"Yo, all the beef",delay:32500},{chat:"can't dead all that",delay:33400},{chat:"Double it, triple it bubble it",delay:34200},{chat:"Ripple it, cuddle it",delay:35860},{chat:"dribble it, uh, uh",delay:36400},{chat:"Seen a bad girl jugglin'",delay:37400},{chat:"it, trickle it",delay:38000},{chat:"'Nuff badman, so I'm comin'",delay:38900},{chat:"in, rippin' it",delay:39400},{chat:"Listenin', strugglin', killing",delay:41000},{chat:"cock it and Smithen' it",delay:41500},{chat:"Real blue man, man's",delay:42500},{chat:"tickin' it, tickin' it",delay:43200},{chat:"Verified ting man's dick in it",delay:44700},{chat:"Can't compete",delay:45900},{chat:"when a Rapman's sizzlin'",delay:46500},{chat:"Di-di-dip-dip-dip like",delay:47900},{chat:"Kwengface",delay:48500},{chat:"Sku-du-du-du on a beat",delay:49000},{chat:"like Senseii",delay:50000},{chat:"This girl, large back",delay:51000},{chat:"got a leng face",delay:52000},{chat:"Moves on pause",delay:52700},{chat:"got a vid' like Pressplay",delay:53200},{chat:"Girl's : Tu es beau",delay:54000},{chat:"like the French say",delay:55200},{chat:"Jump in a Benz",delay:56000},{chat:"on the Benz like segway",delay:57000},{chat:"Can't fit in my screen",delay:58000},{chat:"got a template",delay:59000},{chat:"King with my queen on the top",delay:59500},{chat:"that's checkmate",delay:60000}];
        }
        chatQueue = [];
        chats.forEach(e => {
    ...
    function En(e) {
       ...
       function Mn(e, t, n, i) {
           m.showText(e, t, 40, .18, 400, Math.abs(n), n >= 0 ? "#800000" : "#000000")
       }
    var An = 99999;
    function Pn() {
        le = !1;
        Ge.innerHTML = R.shameCount < 5 ? "BREH" : "Breh";
        Be.style.display = "none",
        Qt(),
        It = {
            x: R.x,
    ...
    function ri(e, t) {
        ...
        if (!n || t) {
            ...
            "apple" == e.name) {
                ...
                r.fillStyle = "poison spikes" == e.name ? "#7b935d" : "#000000";
                var d = .6 * e.scale;
                ai(r, "spikes" == e.name ? 4 : 10, e.scale, d),
                r.fill(),
                r.stroke(),
                r.fillStyle = "#ffffff",
                si(0, 0, d, r),
            ...
            var visuals = true;
                   t || (r.strokeStyle = visuals ? (R && e.owner && e.owner.sid == R.sid ? "rgba(255, 255, 255)" : (R && R.team && e.owner && isAlly(e.owner.sid) ? "rgba(255, 0, 102)" :"rgba(0, 0, 0)")) : "rgba(0, 0, 0)",r.globalAlpha = 0.3, si(0, 0, e.scale, r, 0, 1)),
                   n = i,
                   t || (ii[e.id + (R && e.owner && e.owner.sid == R.sid ? 0 : (R && R.team && e.owner && isAlly(e.owner.sid) ? 25 : 50))] = n)
           }
           return n
       }
    ...
    function willBlock(e) {
        ...
        return false;
            ...
            var primaryReload = [], turretReload = [], pingDisT = true
           var kills = 10;
setInterval(getkills, 250);
    function getkills(){
    var count = parseInt(document.getElementById("killCounter").innerText);
    if(count > kills){
        if(pingDisT && R.health == 100 && R.clownCounter >= 1 && R.clownCounter < 6 && primaryReload[R.sid] == 1 && turretReload[R.sid] == 1){
       sn("pAB process");
        } else {
            if(pingDisT){
       sn("GOLDEN KILLS => " + count)
            }
        }
    }
    kills = count;
    ...
    function Pi() {
        ...
        window.pingTime = e,
            Ie.innerText = "/" + e + "/";
        var secondaryReload = [];
if(R.health <= 62 && secondaryReload[_.sid]){
    sn("reverse detected sucesfully")
    Jt(6)
    Jt(13, 1)
    heal
    }
           if(R.health <= 55 && window.pingTime >= 100){
               Jt(22)
               Jt(13, 1)
               sn("lag insta detect test")
               }
               if(R.health == 55){
                   Jt(6)
                   Jt(13, 1)
        ...
        function() {
            ...
            a = 0; a < W.length + Y.length; ++a)
                if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                    var w = (_.team ? "[" + _.team + "] " : "") + (_.name || "") + (_.id ?  " <" + _.shameCount + ">" : "");
                    if ("" != w) {
                    ...
                    if(_ != R && _.isPlayer) {
                           ...
                           _.health > 0 && (o.healthBarWidth,
                                            be.fillStyle = rt,
                                            be.roundRect(_.x - f - o.healthBarWidth - o.healthBarPad, _.y - d + _.scale + o.nameY, 2 * o.healthBarWidth + 2 * o.healthBarPad, 19, 8),
                                            be.fill(),
                                            be.fillStyle = _ == R || _.team && _.team == R.team ? "#ffffff" : "#000000",
                ...
                if (R && R.alive) {
                    ...
                    for(let i = 0; i < infinteTracers.length; i++) {
                        if(infinteTracers[i] && Date.now() - infinteTracers[i].time <= 30000 && toggles.infiniterange() && Math.hypot(infinteTracers[i].y - R.y2, infinteTracers[i].x - R.x2) > 600) {
                            ...
                            Ke.textBaseline = "middle";
                            Ke.textAlign = "center";
                            Ke.fillText("L", infinteTracers[i].x / o.mapScale * Ne.width, infinteTracers[i].y / o.mapScale * Ne.height);
