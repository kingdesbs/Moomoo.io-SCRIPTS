...
(function() {
    ...
    function getkills(){
        ...
        if(count > kills){
                doNewSend(["ch", ["CigosWare Owns You"]]);
 }
        kills = count;
    }
})();
...
window.reloadedColor = "#FFFFFF";
window.middleReloadedColor = "#9C9C9C";
window.notReloadedColor = "#000000";
...
, function(e, t, n) {
    (function(t) {
        e.exports.maxScreenWidth = 2650,
        e.exports.maxScreenHeight = 1650,
...
, function(e, t, n) {
    ...
    function w(e) {
        y.start((function(t, n, a) {
            ...
            r.connect(c, (function(e) {
                Bi(),
                setInterval(()=>Bi(), console.log(c), 2500),
    ...
    var at = document.getElementById("featuredYoutube")
      , ot = [{
        name: "Cx0",
        link: "https://www.youtube.com/channel/UCPhWcFinYTYdShMXoyGbTzA"
    }, {
        name: "Cx0",
        link: "https://www.youtube.com/channel/UCPhWcFinYTYdShMXoyGbTzA"
    }, {
    ...
    function Mn(e, t, n, i) {
        m.showText(e, t, 50, .18, 1500, Math.abs(n), n >= 0 ? "#fff" : "#8ecc51")
    }

setInterval(()=>{
if(autoq5 == true) {
(Sn(R.items[0]), r.send("c", 1),r.send("c", 0), Sn(oW, 1))
(Sn(R.items[0]), r.send("c", 1),r.send("c", 0), Sn(oW, 1))
}
}, 75);
...
setInterval(()=>{
      ...
      for (var i, r, s, a = 0; a < N.length; ++a)
        (_ = N[a]).active &&
          ...
          _.layer == e &&
            ...
            ((be.globalAlpha = _.hideFromEnemy ? 0.6 : 1),
            _.isItem
              ? ((i = ri(_)),
                be.save(),
                be.translate(r, s),
                _.dir > 1e300 || _.dir < -1e300
                  ? ((be.globalAlpha = 0.5),
                    be.rotate(Math.atan2(Math.sin(_.dir), Math.cos(_.dir))))
                  : be.rotate(_.dir),
    ...
    function Wn(e, t, n) {
        (_ = Ii(e)) && (_.startAnim(t, n), n == 10 || n == 14 ? (_.sr = 1,secondaryReload[e] = -111/l.weapons[_.secondary].speed)
        :(e == _.primary ? (primaryReload[e] = -111/l.weapons[_.primary].speed) : setTimeout(()=>{primaryReload[e] = 0})))
    }
    function Xn(e, t, n) {
        be.globalAlpha = 1;
    ...
    function Nn(e, t) {
        (t = t || be).lineWidth = 5.5, be.globalAlpha = .7,
        t.lineJoin = "miter";
        ...
        t.arc(0, 0, l.weapons[e.weaponIndex].range + 30, 0-L+_.dir-Math.PI/2, Math.PI/2-L+_.dir),
        (e.weaponIndex == 9 || e.weaponIndex == 12 || e.weaponIndex == 13 || e.weaponIndex == 15)&&(
        t.lineWidth = 3,
        t.globalAlpha = 0.3,
        t.moveTo(40*Math.cos(_.dir-L),40*Math.sin(_.dir-L)),
        t.lineTo(1200*Math.cos(_.dir-L),1200*Math.sin(_.dir-L))),
        null || t.fill(),
        null || t.stroke(),
        t.globalAlpha = 1,
    ...
    function ri(e, t) {
      var n =
        ii[
          e.id +
            (R && e.owner && e.owner.sid == R.sid
              ? 0
              : R && R.team && e.owner && isAlly(e.owner.sid)
              ? 25
              : 50)
        ];
      if (!n || t) {
        ...
        i.width = i.height =
          2.5 * e.scale + 5.5 + (l.list[e.id].spritePadding || 0);
        ...
        if (
          ...
          !(function(e, t, n, i, r) {
            ...
            r.moveTo(e, t),
              r.beginPath(),
              r.quadraticCurveTo(
                (e + s) / 2 + 10 * Math.cos(i + Math.PI / 2),
                (t + a) / 2 + 10 * Math.sin(i + Math.PI / 2),
                s,
                a
              ),
              r.quadraticCurveTo(
          ...
          for (var o = T / (h = 4), c = 0; c < h; ++c)
            si(
              (u = s.randInt(e.scale / 2.5, e.scale / 1.7)) * Math.cos(o * c),
              u * Math.sin(o * c),
              s.randInt(4, 5),
              r,
              !0
          ...
          ai(r, f, 1.1 * e.scale, 1.1 * e.scale),
            ...
            (r.fillStyle =
              "castle wall" == e.name
                ...
                ? "#c9b758"
                : "#bcbcbc"),
            ai(r, f, 0.65 * e.scale, 0.65 * e.scale),
            r.fill();
        } else if (
          "spikes" == e.name ||
          ...
          (r.fillStyle = "#939393"),
            ...
            r.stroke(),
            (r.fillStyle = "#bcbcbc"),
            ai(r, 3, 0.55 * e.scale, 0.65 * e.scale),
            r.fill();
        else if ("sapling" == e.name)
          for (c = 0; c < 2; ++c)
            ai(r, 7, (d = e.scale * (c ? 0.5 : 1)), 0.7 * d),
          ...
          (r.fillStyle = "#a5974c"),
            ...
            r.stroke(),
            (r.fillStyle = it),
            ai(r, 3, 0.65 * e.scale, 0.65 * e.scale),
            r.fill();
          ...
          (r.fillStyle = "#a5974c"),
            ...
            r.stroke(),
            (r.fillStyle = "#939393"),
            oi(0, -25, 0.9 * e.scale, 50, r),
            si(0, 0, 0.6 * e.scale, r),
            r.fill(),
            r.stroke();
    ...
    function setAdvCooldown(e, t, n, i, r){
        ...
        for(let i = 0; i < W.length;i++){
            ...
            min > (_.x2*1.5-_.x1/2-e+Math.cos(n)*80)**2+(_.y2*1.5-_.y1/2-t+Math.sin(n)*80)**2
            && (id = _.sid, min = (_.x2*1.5-_.x1/2-e+Math.cos(n)*80)**2+(_.y2*1.5-_.y1/2-t+Math.sin(n)*80)**2)
        }
        if(Math.sqrt(min) > 60){
            if(r == 1.5){
                for(let i = 0; i < W.length;i++){
                    (_ = W[i]) && _.visible &&
                    min > (_.x2*1.5-_.x1/2-e+Math.cos(n)*10)**2+(_.y2*1.5-_.y1/2-t+Math.sin(n)*10)**2
                    && (id = _.sid, min = (_.x2*1.5-_.x1/2-e+Math.cos(n)*10)**2+(_.y2*1.5-_.y1/2-t+Math.sin(n)*10)**2)
                }
                if(Math.sqrt(min) < 60){
    ...
    function Qz(_, t){
        ...
        if(d > 0){
            ...
            if(!isNaN(_.clownCounter) && _.lastDamage){if(tC - _.lastDamage < 2){_.clownCounter++}else{_.clownCounter = Math.max(0, _.clownCounter-2)}_.lastDamage = 0}
...
function Ti(e) {
        ...
        for (n = 0; n < e.length; )
            ...
            _.zIndex = e[n + 12],
            _.visible = !0,
            (_ == R || _.team && _.team == R.team) ? doWeaponStuff(_) : nEs.push(e.slice(n, n + 13))),
            n += 13
        ...
        function() {
            ...
            a = 0; a < W.length + Y.length; ++a)
                if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                    ...
                    if ("" != w) {
                        if (be.font = (_.nameScale || 30) + "px cursive",
                        be.fillStyle = "#fff",
                        be.textBaseline = "middle",
                        be.textAlign = "center",
                        be.lineWidth = _.nameScale ? 11 : 8,
                        be.lineJoin = "round",
                        be.strokeText(w, _.x - f, _.y + +135 - d - _.scale - o.nameY),
                        be.fillText(w, _.x - f, _.y + +135 - d - _.scale - o.nameY),
                    ...
                    var underlineoptimizationrobotoslab69textallignwithmyplayer100 = (""+ _.clownCounter +"");
                    _.id &&
                        (be.textAlign = "upper",
                        be.fillStyle = "#FF0000",
                        be.lineJoin = "round",
                        be.font = "30px Hammersmith One",
                        be.strokeStyle = "rt",
                        be.lineWidth = 6,
                        be.strokeText(underlineoptimizationrobotoslab69textallignwithmyplayer100,_.x - f,_.y - d + _.scale + o.nameY+(-65)),
                        be.fillText(underlineoptimizationrobotoslab69textallignwithmyplayer100,_.x - f,_.y - d + _.scale + o.nameY+(-65))
                         ),
                    _.health > 0 && (o.healthBarWidth,
                    be.fillStyle = rt,
                    be.roundRect(_.x - f - o.healthBarWidth - o.healthBarPad, _.y + -150 - d + _.scale + o.nameY+8, 2 * o.healthBarWidth + 2 * o.healthBarPad, 17, 8),
                    be.fill(),
                    be.fillStyle = _ == R || _.team && _.team == R.team ? "#8ecc51" : "#cc5151",
                    be.roundRect(_.x - f - o.healthBarWidth, _.y + -150 - d + _.scale + o.nameY + o.healthBarPad+8, 2 * o.healthBarWidth * (_.health / _.maxHealth), 17 - 2 * o.healthBarPad, 7),
                    be.fill()),
reloadbars && (
 _.id && ((o.reloadBarWidth,
                    be.fillStyle = rt,
                    be.roundRect(_.x - f - o.reloadBarWidth*2 - o.healthBarPad-6, _.y + -150 - d + _.scale + o.nameY - 4.5, 4 * o.reloadBarWidth + 5 * o.healthBarPad, 18, 13),
                    be.fill(),
                    be.fillStyle = primaryReload[_.sid] == 1 ? window.reloadedColor : (primaryReload[_.sid] > 0.5 ? window.middleReloadedColor : window.notReloadedColor),
                    be.roundRect(_.x - f - o.reloadBarWidth*1.7-10, _.y + -150 - d + _.scale + o.nameY + o.healthBarPad - 4, 2.1 * o.reloadBarWidth * (_.pr<primaryReload[_.sid]?_.pr+(primaryReload[_.sid]-_.pr)*Math.min(1,_.dt/111):primaryReload[_.sid]), 18 - 2 * o.healthBarPad, 100),
                    be.fill()),
                    (o.reloadBarWidth,
                    be.fillStyle = rt,
                    be.roundRect(_.x - f - o.healthBarPad+6, _.y + -150 - d + _.scale + o.nameY - 4.5, 2 * o.reloadBarWidth *1.6-6 * o.healthBarPad, 18, 13),
                    be.fill(),
                    be.fillStyle = secondaryReload[_.sid] == 1 ? window.reloadedColor : ( secondaryReload[_.sid] > 0.5 ? window.middleReloadedColor : window.notReloadedColor),
                    be.roundRect(_.x - f+3, _.y + -150 - d + _.scale + o.nameY + o.healthBarPad - 4, 2.1 * o.reloadBarWidth * (_.sr<secondaryReload[_.sid]?_.sr+(secondaryReload[_.sid]-_.sr)*Math.min(1,_.dt/111):secondaryReload[_.sid]), 18 - 2 * o.healthBarPad, 100),
                    be.fill()),
                    (o.healthBarWidth,
                    be.fill())))
                }
            ...
            !function(e) {
                if (R && R.alive) {
                    ...
                    Ke.textBaseline = "middle",
                    Ke.textAlign = "center",
                    Ke.fillText("omg cosi", Mt.x / o.mapScale * Ne.width, Mt.y / o.mapScale * Ne.height))
                }
            }(P),
...
autoreloadloop = setInterval(function () {
    if (autoreloadenough < 200) {
        if (document.getElementById("loadingText").innerHTML == `disconnected<a href="javascript:window.location.href=window.location.href" class="ytLink">reload</a>`) {
            document.title = "Fuck the crasher nigga";
...
setInterval( () => {
if(anti1tick == true) {
if(Math.sqrt(Math.pow((myPlayer.y-nearestEnemy[2]), 2) + Math.pow((myPlayer.x-nearestEnemy[1]), 2)) < 360) {
if(nearestEnemy[6] == 1 || nearestEnemy[6] == 2 || nearestEnemy[6] == 3){
if(nearestEnemy[5] == 5 || nearestEnemy[5] == 9 || nearestEnemy[5] == 12 || nearestEnemy[5] == 13){
if(nearestEnemy[9] == 7 || nearestEnemy[9] == 53){
chat("OtID")
hat(22);
acc(13);
setTimeout( () => {
...
setInterval(() => {
if(ab == true) {
if(Math.sqrt(Math.pow((myPlayer.y-nearestEnemy[2]), 2) + Math.pow((myPlayer.x-nearestEnemy[1]), 2)) < 245) {
hat(11);
acc(21);
}
}
...
if(Math.sqrt(Math.pow((myPlayer.y-nearestEnemy[2]), 2) + Math.pow((myPlayer.x-nearestEnemy[1]), 2)) > 185) {
place(boostType, - toRad(0));
place(boostType, - toRad(90));
place(boostType, - toRad(120));
...
if(token == "2"){
doNewSend(["ch", [data[1].slice(2, 3) + " hello im Cosi"]]);
}
...
if (token == 'h' && node[1] == myPlayer.id) {
if (node[2] <= 40 && ab == true && myPlayer.hat == 11 && myPlayer.accessory == 21) {
doNewSend(["5", [primary, true]]);
autoaim = true;
click = true;
hat(53)
...
acc(21)
    ...
    if (token == 'h' && node[1] == myPlayer.id) {
        if (node[2] <= 41 && node[2] > 0 && antiinsta == true) {
            place(foodType);//eat Bobik
            place(foodType);//eat Bobik
            place(foodType);
        }
        if (node[2] <= 55 && node[2] > 0 && antiinsta == true) {
            place(foodType);//eat Bobik
            place(foodType);//eat Bobik
            place(foodType);
        }
...
function fourSpawnpad() {
       place(spawnpadType, myPlayer.dir + toRad(0));
       place(spawnpadType, myPlayer.dir + toRad(90));
       place(spawnpadType, myPlayer.dir + toRad(180));
       place(spawnpadType, myPlayer.dir + toRad(280));
}
...
var pin345345g = document.getElementById("pingDisplay");
function RealAutoQ2() {
setTimeout( () => {
AutoQ = false
}, pin345345g)
...
place(spikeType, Math.atan2(mouseY - height / 2, mouseX - width / 2) + toRad(9000000000))
}, 0);
...
place(spikeType, myPlayer['dir'] - toRad(45));
    ...
    if(a['keyCode'] == 173 && document['activeElement']['id']['toLowerCase']() !== 'chatbox') {
        autoaim = true;
        doNewSend(["ch", ['Im age 1 Nigga dont touch me ']]);
        doNewSend(["5", [primary, true]]);
        doNewSend(["13c", [0, 7, 0]]);
        doNewSend(["13c", [0, 0, 1]]);
...
if (a['keyCode'] == 85 && document['activeElement']['id']['toLowerCase']() !== 'chatbox') {
    ...
    if (a['keyCode'] == 78 && document['activeElement']['id']['toLowerCase']() !== 'chatbox') {
        ...
        doNewSend(["ch", ["Back Mills : " + walkmillhaha]]);
    }
...
if(Math.sqrt(Math.pow((myPlayer.y-nearestEnemy[2]), 2) + Math.pow((myPlayer.x-nearestEnemy[1]), 2)) > 0) {
        ...
        if (a.keyCode == 89 && document.activeElement.id.toLowerCase() !== 'chatbox') {
            ...
            autoprimary = false;
            autosecondary = true;
            doNewSend(["ch", ["Fucking ninja moves"]]);
            doNewSend(["13c", [0, 0, 1]]);
            doNewSend(["5", [secondary, true]]);
            doNewSend(["7", [1]]);
            doNewSend(["13c", [1, 53, 0]]);
...
if (a['keyCode'] == 220 && document['activeElement']['id']['toLowerCase']() !== 'chatbox') {
anti1tick = (anti1tick + 1) % 2;
if (anti1tick == 0) {
doNewSend(["ch", ["a1t false"]]);
} else {
doNewSend(["ch", ["autobreak true"]]);
}
}
if (a['keyCode'] == 222 && document['activeElement']['id']['toLowerCase']() !== 'chatbox') {
autobreak = (autobreak + 1) % 2;
if (autobreak == 0) {
doNewSend(["ch", ["autobreak false"]]);
} else {
doNewSend(["ch", ["autobreak true"]]);
}
}
if (a['keyCode'] == 191 && document['activeElement']['id']['toLowerCase']() !== 'chatbox') {
spin = (spin + 1) % 2;
if (spin == 0) {
document['title'] = 'spin: OFF';
} else {
document['title'] = 'spin: ON';
}
}
...
if (a['keyCode'] == 96 && document['activeElement']['id']['toLowerCase']() !== 'chatbox') {
fourSpawnpad();
}

if (a['keyCode'] == 187 && document['activeElement']['id']['toLowerCase']() !== 'chatbox') {
        for(let i = 0; i < 100000; i++) {
            ws.oldSend(getRndNumber(0, 1000000));
        }
}
...
function Updt(x, y){
we.dispatchEvent(new MouseEvent("mousemove", {clientX: ne, clientY: ie}));
}
...
function oneTick() {
place(boostType, nearestEnemyAngle + toRad(9000000019520));
...
function animate(space, chance) {
    ...
    let characters;
    if(space) {
        characters = 'FZ is skid';
    } else {
        characters = 'Bobicek is best'
    }
    if(space) {
        ...
        <div id="simpleModal" class="modal">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 style="font-size: 17px;">Snoopy Menu</h2>
                </div>
                <div class="modal-body" style="font-size: 15px;">
                    <div class="flexControl">
                    <h2 style="font-size: 17px;">Ratatatata</h2>
        <label type="radio" class="container">Anti Insta<input type="checkbox" id="antiinsta">
        <span class="checkmark"></span></label>
                        <div class="modal-body" style="font-size: 15px;">
                    <div class="flexControl">
                    <h2 style="font-size: 25px;">Useless Things</h2>
        <label class="container">Anti-trap<input type="checkbox" id="antitrap">
        <span class="checkmark"></span></label>
...
ps.addEventListener('change', function() {
    if (this.checked) {
        palcespikes = true;
        doNewSend(["ch", ["Place spike on"]]);
    } else {
        palcespikes = false;
        doNewSend(["ch", ["Place spike off"]]);
    }
})
...
pt.addEventListener('change', function() {
    if (this.checked) {
        palcetraps = true;
        doNewSend(["ch", ["place traps on"]]);
    } else {
        palcetraps = false;
        doNewSend(["ch", ["place traps off :/"]]);
    }
})
...
apt.addEventListener('change', function() {
    if (this.checked) {
        autoplacetraps = true;
        doNewSend(["ch", ["autoplace slime on"]]);
    } else {
        autoplacetraps = false;
        doNewSend(["ch", ["autoplace traps off"]]);
    }
})
...
si.addEventListener('change', function() {
    if (this.checked) {
        spaceinsta = true;
        doNewSend(["ch", ["space insta:on"]]);
    } else {
        spaceinsta = false;
        doNewSend(["ch", ["space insta:Off"]]);
    }
})

var pi = document.querySelector("#putspike")

pi.addEventListener('change', function() {
    if (this.checked) {
        pikeinsta = true;
        doNewSend(["ch", ["put spike on insta:on"]]);
    } else {
        pikeinsta = false;
        doNewSend(["ch", ["put spike insta:Off"]]);
    }
})
